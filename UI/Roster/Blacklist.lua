...
function BuildBlacklistUI()
    ...
    local function PrepareData()
        ...
        table.sort(data, function(a, b) return a.fullName < b.fullName end)
        return data
    end
    ...
    DF:CreateLabel(blacklist_frame, "Player Name", 11):SetPoint("TOPLEFT", blacklist_frame, "TOPLEFT", 20, -30)
